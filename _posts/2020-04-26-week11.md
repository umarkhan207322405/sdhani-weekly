...
## It's a TON of Coordination :nerd_face:
...
Last week I mentioned commenting on an issue for Cloudflare Workers. Since I encountered a few missteps in their Quick Start link for working with Workers, I sumbitted a [PR to Cloudflare](https://github.com/cloudflare/workers-docs/pull/752) to update their steps, that likely became outdated during a client-side update.
