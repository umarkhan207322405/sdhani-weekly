...
| 9 | [Fix with-aphrodite typo in README](https://github.com/zeit/next.js/pull/11436) | Next.js Contrib | Fix with-aphrodite typo in README. Changed This example features how yo use to This example features how to use. |
...
| 9 | [Added gem plugin to config file](https://github.com/hunter-college-ossd-spr-2020/liulanz-weekly/pull/11) | Blog Edit | Edited config.yml file. Added emoji-support for Liulanz's blog :high_brightness: |