...
| 7 | [PR for project evaluation](https://github.com/nyu-ossd-s20/project-evaluation/pull/82) | **NYU** Project Evaluation | Submitted a project evaluation for the Ember.js project to the nyu-ossd-s20/project-evaluations repository. |
...
| 10 | [Minor grammatical suggestions](https://github.com/hunter-college-ossd-spr-2020/MichelleLucero-weekly/pull/6) | Blog Edit | Suggested some phrase changes |
| 10 | [Minor grammatical suggestions](https://github.com/hunter-college-ossd-spr-2020/ElijahCano33-weekly/pull/9) | Blog Edit | Suggested some phrase changes, fixed a typo |
...
| 11 | [with-env-from-next-config-js README modification](https://github.com/zeit/next.js/pull/12153) | **Next.js** Contribution | Added a line to the with-env-from-next-config-js example README to include a link to Next.js's new docs on setting up environment variables in a Next.js project. |
| 11 | [PR to Quick Start Docs Suggestion](https://github.com/cloudflare/workers-docs/pull/752) | **Cloudflare** Contribution | Suggested some changes to two sections in Cloudflare's *[Quick Start](https://developers.cloudflare.com/workers/quickstart)* tutorial for setting up *Workers*. I provided an updated workflow for accessing a user's API token and Global API token from the client side. |